...
完成了作业的必做部分，具体功能和介绍详见后文项目说明，演示视频和ppt在./video/目录下
...
# 项目说明
1. 本项目是一个基于python的网络爬虫,用于从小红书爬取用户的笔记信息
2. 项目包含两个主要功能模块:scraper.py和process.py
...
4. 如果需要单独运行某个模块,请在项目根目录下运行`python src/scraper.py`或`python src/process.py`
